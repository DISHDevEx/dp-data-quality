...
def test_generate_result_location(test_object):
    ...
    expected_result_target_prefix = f"s3a://{target_bucket}/{target_prefix}/s3_to_s3_validation_result_{target_bucket}_this_is_a_ test _string/"
    incorrect_result_target_prefix = f"s3a://{target_bucket}/{target_prefix}/s3_to_s3_validation_result_{target_bucket}_this/is/a/ test /string/"
